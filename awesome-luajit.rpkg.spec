...
Name:       awesome
Version:    {{{ git_version name=awesome lead=4.3 }}}
Release:    1%{?dist}
...
VCS:        git+https://github.com/JCallicoat/awesome#HEAD:
...
- Use `git_version` and `git_dir_pack` macros
- Drop vi default editor patch
